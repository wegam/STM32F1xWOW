...
#define	Port_DS2401DIO	GPIOC
#define	Pin_DS2401DIO		GPIO_Pin_2

#define	DS2401DIO_SetOut	GPIO_Configuration_OPP50(Port_DS2401DIO,	Pin_DS2401DIO)			//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度50MHz----V20170605
#define	DS2401DIO_SetIn		GPIO_Configuration_IPU(Port_DS2401DIO,	Pin_DS2401DIO)			//将GPIO相应管脚配置为下拉输入模式----V20170605

#define	DS2401DIO_H			Port_DS2401DIO->BSRR 	= Pin_DS2401DIO			//CPLD_WR	=	1;
#define	DS2401DIO_L			Port_DS2401DIO->BRR 	= Pin_DS2401DIO			//CPLD_WR	=	0;

#define	DS2401DIO_Read	Port_DS2401DIO->IDR & Pin_DS2401DIO			//CPLD_WR	=	0;
...
{
	GPIO_Configuration_OPP50	(Port_DS2401DIO,	Pin_DS2401DIO);			//将GPIO相应管脚配置为PP(推挽)输出模式，最大速度50MHz----V20170605
}
/*******************************************************************************
* 函数名			:	function
...
* 输入			: 开始8位是单线产品系列代码
* 返回值			: 接着48位是唯一序列号，最后8位是前56位的CRC值
*******************************************************************************/
