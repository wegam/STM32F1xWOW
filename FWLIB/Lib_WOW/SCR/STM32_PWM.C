...
//	}
//	
//	PWM_Tim->PWM_Ratio	=	(PWM_Tim->PWM_Ratio)	/	b;
//	PWM_Tim->PWM_Cycle		=	100	/	b;
//	PWM_Tim->PWM_Count	=	0;
//	PWM_Tim->Pulse	=	0;
//	
//	temp	=	PWM_Tim->PWM_Ratio;
//	temp	=	PWM_Tim->Pulse;
//	temp	=	PWM_Tim->PWM_Cycle;
//	temp	=	PWM_Tim->PWM_Count;

//	//*6.2.2,计算实际运行频率******************************************************************
//	PWM_Frequency	=	(double)(PWM_Tim->PWM_Frequency	*	PWM_Tim->PWM_Cycle);
//	
//	//*6.2.3,获取TIMx时钟**********************************************************************
//	//1）-----分频值及自动重装载值计算（PWM_Frequency 频率，单位Hz）
//	//--------1MHz 1us=1000ns,1KHz 10us=10000ns
...
{
//	volatile u8	temp	=	0;
//	PWM_Tim->PWM_Count	=	PWM_Count;
//	temp	=	PWM_Tim->PWM_Count;
//	if(PWM_Tim->PWM_Count	!=	0)
//	{
//		PWM_Tim->Pulse	=	0;
//		TIM_Cmd(&(PWM_Tim->TIMx), ENABLE); 									//使能TIM
//		PWM_Tim->GPIOx.BSRR = PWM_Tim->GPIO_Pin_n;			//GPIO_SetBits(GPIO_TypeDef* GPIOx, u16 GPIO_Pin);								//输出高
//	}
//	else
//	{
//		PWM_Tim->GPIOx.BRR = PWM_Tim->GPIO_Pin_n;			//GPIO_ResetBits(GPIO_TypeDef* GPIOx, u16 GPIO_Pin);						//输出低
//		TIM_Cmd(&(PWM_Tim->TIMx), DISABLE); 									//禁止TIM
//	}
}
/*******************************************************************************
* 函数名			:	function
...
{
//	volatile u8	temp	=	0;
//	if((PWM_Tim->TIMx.SR & TIM_IT_Update)	== TIM_IT_Update)
//	{
//		temp	=	PWM_Tim->PWM_Ratio;
//		temp	=	PWM_Tim->Pulse;
//		temp	=	PWM_Tim->PWM_Cycle;
...
//			PWM_Tim->GPIOx.BRR = PWM_Tim->GPIO_Pin_n;			//GPIO_ResetBits(GPIO_TypeDef* GPIOx, u16 GPIO_Pin);						//输出低
//			TIM_Cmd(&(PWM_Tim->TIMx), DISABLE); 															//禁止TIM
//			TIM_ClearFlag(&(PWM_Tim->TIMx), TIM_FLAG_Update);								//清除中断标志			
//			return 1;
//		}		
//		
//		PWM_Tim->Pulse++;
//		
//		if(PWM_Tim->Pulse>=PWM_Tim->PWM_Cycle)
//		{
//			PWM_Tim->Pulse	=	0;
//			PWM_Tim->PWM_Count--;
//		}
//		else if(PWM_Tim->Pulse	<	PWM_Tim->PWM_Ratio)
//		{
//			PWM_Tim->GPIOx.BSRR = PWM_Tim->GPIO_Pin_n;			//GPIO_SetBits(GPIO_TypeDef* GPIOx, u16 GPIO_Pin);								//输出高
//		}
//		else
