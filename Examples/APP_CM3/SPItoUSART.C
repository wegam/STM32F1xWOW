...
void SPItoUSART_Configuration(void)
{
	...
	GPIO_Configuration_APP50(GPIOC,GPIO_Pin_9|GPIO_Pin_12);			//GPIO配置
	GPIO_Configuration_APP50(GPIOD,GPIO_Pin_2);			//GPIO配置
	GPIO_Configuration_APP50(GPIOB,GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9);			//GPIO配置
...
//	USART_DMA_Configuration(USART1,115200,1,1,(u32*)Usart_Test_Buffer,(u32*)Usart_Test_Buffer,DMA1_BufferSize);	//USART_DMA配置
	...
	STM32_SPI_ConfigurationNR((u32*)SPI_Tx_Buffer,(u32*)SPI_Rx_Buffer,SPI_BufferSize);
